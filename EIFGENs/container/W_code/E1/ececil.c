...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5046, "test_array_ref_copy", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5047, "test_array_shallow_copy", closed [1].it_r))(closed [1].it_r);
}
