...
struct eif_ex_391 {union overhead overhead; char data [8];};
struct eif_ex_397 {union overhead overhead; char data [8];};
...
struct eif_ex_903 {union overhead overhead; char data [8];};
