...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 979, Current, 0, 2, 13576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 979, Current, 0, 3, 13577);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 979, Current, 3, 0, 13578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F980_7343 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 13579);
	RTSA(Dtype(Current));
	RTSC;
