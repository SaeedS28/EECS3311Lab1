...
extern void F980_7339(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F980_7340(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F980_7339 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5153, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F980_7340 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F980_7341 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(5150,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F980_7342 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(5151,Dtype(Current)));
	return r;
}
