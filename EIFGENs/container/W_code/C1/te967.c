...
extern void F967_7215(EIF_REFERENCE);
...
void F967_7215 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A967_77, (EIF_POINTER)(0),5037, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A967_78, (EIF_POINTER)(0),5038, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5012, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 966, Current, 3, 0, 13473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	RTHOOK(13);
	RTDBGAL(Current, 1, 0xF80001C0, 0, 0); /* loc3 */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1758, "count", loc1))(loc1)).it_i4);
	ui4_1 = ti4_1;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 966, Current, 4, 0, 13474);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
	...
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	RTHOOK(18);
	RTDBGAL(Current, 2, 0xF80001C0, 0, 0); /* loc4 */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1758, "count", loc1))(loc1)).it_i4);
	ui4_1 = ti4_1;
	tr1 = RTLN(eif_new_type(217, 0x00).id);
	*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
