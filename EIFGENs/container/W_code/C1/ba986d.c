...
static const EIF_TYPE_INDEX egt_13_986 [] = {0xFF01,263,0xFF01,231,0xFFFF};
...
static const struct desc_info desc_986[] = {
	...
	{EIF_GENERIC(egt_13_986), 13585, 0},
	...
	{EIF_GENERIC(egt_14_986), 13594, 0xFFFFFFFF},
};
void Init986(void)
{
	IDSC(desc_986, 0, 985);
	IDSC(desc_986 + 1, 1, 985);
	IDSC(desc_986 + 32, 358, 985);
}
