...
extern void F986_7362(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_ASSIGN_AT}.assign_at */
void F986_7362 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 2, 13599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13599);
...
body:;
	...
	ui4_1 = arg1;
	ur1 = RTCCL(arg2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5153, 981))(Current, ui4_1x, ur1x);
	RTHOOK(3);
	...
	tr6 = RTMS_EX_H("WrongAgain!",11,1859818273);
	ur1 = tr6;
	ui4_1 = arg1;
