...
extern void F981_7344(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F981_7345(EIF_REFERENCE);
...
void F981_7344 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 980, Current, 0, 2, 13581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5147, 0xF8000125, 0); /* case */
	RTAR(Current, arg2);
...
void F981_7345 (EIF_REFERENCE Current)
{
	GTCX
