...
extern void F982_7353(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F982_7353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 2, 13590);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5156, 0xF8000159, 0); /* case */
	RTAR(Current, arg2);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 3, 0, 13591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
