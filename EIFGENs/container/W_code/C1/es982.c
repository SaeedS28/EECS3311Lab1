...
extern void F982_7351(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 2, 13587);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5153, 0xF8000159, 0); /* case */
	RTAR(Current, arg2);
...
void F982_7351 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 3, 0, 13588);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
