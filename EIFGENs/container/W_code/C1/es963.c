...
#define ub1 ub1x.it_b
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,434,0xFF01,966,0xFFFF};
		EIF_TYPE typres0;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4982, 0xF80001B2, 0); /* test_classes */
	RTAR(Current, arg3);
...
#define up1 up1x.it_p
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(4979, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	for (;;) {
		...
		RTHOOK(12);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5031, "cases", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		loc3 = RTCCL(tr1);
		if (EIF_TEST(loc3)) {
			RTHOOK(13);
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5138, "is_violation_case", loc4))(loc4)).it_b);
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc4 + RTVA(5141, "passed", loc4));
					if (tb3) {
						RTHOOK(18);
						RTDBGAA(Current, dtype, 4977, 0x10000000, 1); /* number_passed_violation */
...
#define ui4_1 ui4_1x.it_i4
	...
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN)(loc1 != NULL)) {
				RTHOOK(10);
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5032, "name", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				loc5 = RTCCL(tr1);
				if (EIF_TEST(loc5)) {
					RTHOOK(11);
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4970, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
